...
module.exports = {
    ...
    AFN: process.env.ALL_CAPTION === undefined ? '*MADE BY YOUR 𝓝𝓮𝓻𝓭𝔂 𝓑𝓸𝓽🌹*' : process.env.ALL_CAPTION,
    ...
    SOURAVKL11: process.env.STICKER_DATA === undefined ? 'Jasmine|Sisaco' : process.env.STICKER_DATA,
    ANTI_FAKE: process.env.AUTO_FAKE === undefined ? 'sisaco' : process.env.AUTO_FAKE,
    ...
    SKDR: process.env.DURATION === undefined ? '9995595' : process.env.DURATION,
    HANDLERS: process.env.HANDLERS === undefined ? '^[.💜!;]' : process.env.HANDLERS,
    SEND_READ: process.env.SEND_READ === undefined ? false : convertToBool(process.env.SEND_READ),
    YAK: process.env.YAK === undefined ? '919995595067' : process.env.YAK,
    ...
    SUDO: process.env.SUDO === undefined ? '919995595067,0' : process.env.SUDO,
    DEBUG: DEBUG,
